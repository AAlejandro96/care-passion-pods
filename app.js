...
const aliasMap = {
    "AALEJANDRO": "Antonio Alejandro",
    "ADURAISWAMY": "Arunkumar Duraiswamy",
    ...
    "AMAHME": "Ameer Ahmed",
    "AMANJHA": "Aman Jha",
    "AMANSAHNI": "Aman Sahni",
    "AMITKUMAR4": "Amit Kumar",
    "AMKUMA": "Amit Kumar",
    "AMULYAEEDARA": "Amulya Eedara",
    "ANDYPUNT": "Andy Puntahachart",
    "ANJANACHUGH": "Anjana Chugh",
    "ANKVARSHNEY": "Ankit Varshney",
    "ANNANGIA": "Anshul Nangia",
    "ANOLIVEIRA": "Angelo Oliveira",
    "AUBEAUCH": "Austin Beauchamp",
    "BANDANITHIN": "Nithin Banda",
    "BOACHI": "Bogdan Alexandru Achim",
    "CARTERRYAN": "Ryan Carter",
    "CHASIG": "Chandan Kumar Singh",
    "CHATTERJEESO": "Soumodipto Chatterjee",
    "CHAUDHARYSUD": "Sudhir Chaudhary",
    "CHRICHAV": "Christian Chavez Castillo",
    "CHRLEW": "Chris Lewis",
    "COGULIMA": "Cosmin Guliman",
    "COLINFR": "Colin Fritzke",
    "CORYPO": "Cory Posada",
    "CPENCHOEN": "Chris Penchoen",
    "CRISK": "Cristina Knecht",
    "CURTISLEWIS": "Curtis Lewis",
    "DANIMAN": "Dan Manrique",
    "DAVIDVEST": "David Vest",
    "DKOUZMANOV": "Doyko Kouzmanov",
    "ELEANORFALLA": "Eleanor Falla",
    "FLKELLY": "Fletcher Kelly",
    "GMCGARTY": "Geordie (JOR-dee) McGarty",
    "GOLIVEIRA": "Gustavo Oliveira",
    "GUMAULER": "Gustavo Mauler",
    "HACHOW": "Hanisha Chowdary Sava",
    "HENASCIM": "Helder Nascimento",
    "HEVARY": "Hemanth Varyani",
    "HFIKRI": "Hicham Zaki",
    "IEVATODD": "ieva Todd",
    "ITAMARH": "Itamar Hirosh",
    "JARNOLD": "John Arnold",
    "JARYCHLIK": "Jamila Rychlik",
    "JENNAKERAI": "Jenna Kerai",
    "JEREMYK": "Jeremy Kelly",
    "JERRYABO": "Jerry Abouelnasr",
    "JESKO": "Jesse Kopavi",
    "JITHESHR": "Jithesh Raj",
    "JOIBARR": "Josef Ibarra",
    "KAGREGOR": "Karl Gregory",
    "KAKREH": "Kacey Krehbiel",
    "KANIKAKAPOOR": "Kanika Kapoor",
    "KAPALAN": "Karuppaiah Palaniappan",
    "KARANR": "Karan Rustagi",
    "KARTHIKMR": "Karthik Muthiah R",
    "KBAGGA": "Kanishka Bagga",
    "KRITITHAKRAL": "Kriti Thakral",
    "KRODRIGUEZ": "Karl Rodriguez",
    "KVONDERBURG": "Kelsey von der Burg",
    "LANCEWES": "Lance Westby",
    "LSHRIDHARA": "Lavanya Shridhara",
    "LUIORT": "Luis Ortega Villalva",
    "LUKER": "Luke Ramsdale",
    "MAATHANGIK": "Maathangi Kannan Vaidehi",
    "MACHANDR": "Manoj Chandran",
    "MANEGRIN": "Marco Negrinho",
    "MANUPA": "Manaswi Upadhyaya K",
    "MASTEIN": "Max Stein",
    "MGULLEDGE": "Mitchell Gulledge",
    "MICHAESMITH": "Michael Smith",
    "MICHCU": "Michael Curtis",
    "MIKEAUDAM": "Mike Audam",
    "MILINDB": "Milind Bhavsar",
    "MMIKKELSON": "Maygan Mikkelson",
    "MTHALLA": "Mahesh Babu Thalla",
    "MVANPRAAG": "Martijn van Praag",
    "NATANK": "Natan Kfir",
    "NATEEP": "Natee Pretikul",
    "NATRIPAT": "Nandan Tripathi",
    "NEILLOKEEFFE": "Neill O'Keeffe",
    "NIBINPM": "Nibin Mohanan",
    "NILEIJSS": "Niels Leijssenaar",
    "NIVABITBOL": "Niv Abitbol",
    "NSUHAS": "Nandeesh Swami",
    "OMARJANABI": "Omar Janabi",
    "PAMOONEY": "Paul Mooney",
    "PARESHN": "Paresh Nhathalal",
    "PATELRUTWIK": "Rutwik Patel",
    "PESANTO": "Pedro Santos",
    "PRAMKUM": "Pramod HK",
    "PREN": "Premkumar N",
    "PUDWIVEDI": "Purish Dwivedi",
    "RCHISMAN": "Raheem Chisman",
    "REXZH": "Rex Zhao",
    "RMORIARTY": "Robert Moriarty",
    "ROBYNN": "Robyn Nolan",
    "RONMUSTARD": "Ron Mustard",
    "ROTRAVES": "Rodrigo Travessa",
    "SALONIEVYAS": "Salonie Vyas",
    "SANDRESS": "Steven Andress",
    "SAQIBZ": "Saqib Zulfiqar",
    "SATHIYS": "Sathiyanathan Subramanian",
    "SAUSWIN": "Srivatsav Ausvin",
    "SDEINES": "Stefani Deines",
    "SHERRYSHAO": "Sherry Shao",
    "SIMIDDLETON": "Simon Middleton",
    "SKASERA": "Shalini Kasera",
    "SKRYLOV": "Stas Krylov",
    "SOCHUBA": "Somi Ochuba",
    "SOPHYANG": "Sophia Yang",
    "SRASHEED": "Shadab Rasheed",
    "STEVENCOOPER": "Steven Cooper",
    "SUBHASAHOO": "Subha Sahoo",
    "SUBUDHAN": "Suraj Budhani",
    "SVARTANIAN": "Serina Vartanian",
    "THBLEDSO": "TJ Bledsoe",
    "TIHAINTZ": "Tim Haintz",
    "TIMGRIFFIN": "Tim Griffin",
    "TOMASSATALA": "Tomas Satala",
    "TONGONZALEZ": "Tony Gonzalez",
    "VBRENNYDOSSA": "Vinicius Brenny",
    "VCHANGARATH": "Vimaldas Changarath",
    "VIKADONHIN": "Vika Donhin",
    "VISHNUTJ": "VishnuKumaran T J",
    "YBAO": "Yunduan Bao",
    "ZESILVA": "Zélia Silva"
};
